...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', size = 'md', loading = false, className, disabled, children, ...props }, ref) => {
    ...
    const variantStyles = {
      ...
      secondary: 'bg-gray-100 text-dark-800 hover:bg-gray-200 focus:ring-gray-300',
      danger: 'bg-alert text-white hover:bg-red-600 focus:ring-alert',
      ghost: 'text-dark-800 hover:bg-gray-100 focus:ring-gray-300',
    }
